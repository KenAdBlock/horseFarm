...
if(!doesConnectionExist("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.js")) {
    document.write('<script type="text/javascript" src="' + base_url + 'webroot/js/materialize.min.js"></script>');
} else {
    document.write('<script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.js"></script>');
}